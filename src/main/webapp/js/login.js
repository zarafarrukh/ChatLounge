//functions call to backend when user enters username and password or creates a new pair

//call backend with a restful fetch to create a new user
function createUser() {
    LoginPage();
    var username = document.getElementById("createusername").value;
    var password = document.getElementById("createpassword").value;
    const url = "http://localhost:8080/ChatLoungeServer-1.0-SNAPSHOT/api/chatlounge-server/create-account/"+ username +"/" + password;
...
function login(){
    ...
    const url = "http://localhost:8080/ChatLoungeServer-1.0-SNAPSHOT/api/chatlounge-server/login/"+ username +"/" + password;
